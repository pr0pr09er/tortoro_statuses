...
urlpatterns = [
    ...
    path('get_order/<int:pk>/', order_detail, name="order-detail"),
    path('get_workers/', worker_list, name="workers-list"),
    path('get_worker/<int:pk>/', worker_detail, name="worker-detail"),
    path('get_posts/', post_list, name="posts-list"),
    path('get_post/<int:pk>/', post_detail, name="post-detail"),
    path('get_statuses/', status_list, name="statuses-list"),
    path('get_status/<int:pk>/', status_detail, name="status-detail"),
]
